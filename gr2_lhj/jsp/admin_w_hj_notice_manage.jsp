...
<body>
    ...
    <div class="paging">
        ...
        <button style="border:none; color:white; background-color:#999; margin-left:500px">등록하기</button>
    </div>
</div>
...
<div id="modal_wrap" style="position:absolute; width:100%; height:100%; top:0; left:0; background-color:rgba(153,153,153,0.7);">
	<div style="position:absolute; top:10%; left:25%; width:50%; background-color:white; color:black; ">
