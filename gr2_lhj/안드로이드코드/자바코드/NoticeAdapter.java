...
public class NoticeAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.notice_list_view, parent, false);
        }
        ...
        Notice myItem = getItem(position);
    ...
    public void addItem(String name, String contents) {
        ...
        Notice mItem = new Notice();
        System.out.println(name+"addItem실행");
