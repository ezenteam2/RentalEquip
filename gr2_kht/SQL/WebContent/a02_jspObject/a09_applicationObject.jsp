...
<%--
# application 기본 객체
	1. 서버 단위로 특정한 변수/객체를 선언하거나
		application.setAttribute()
		application.getAttribute()
	2. 서버의 초기 파라미터를 설정해서, 웹서비스(JSP)나 controller, service에서 공통적으로 사용 가능
		1) 처리 프로세스
			- web.xml에서 서버단위 특정데이터 설정
			- application 객체 단위로 설정된 데이터 가져오기
 ...
 --%>
	...
	<%
	// application.getInitParameterNames() : 선언된 속성을 가져옴
	//	1. return 값 : Enumeration 객체
	//	2. .nextElement() 해당 요소의 key값 가져오기
	//	3. .hasMoreElements() 해당 요소를 하나씩 가져오기 (다음 값이 있는지 여부 boolean)
